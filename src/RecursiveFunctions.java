 ...
 * takes in integer
 * returns double that's the factorial of integer
 */
public class RecursiveFunctions {
     ...
     * use pow function to multiply base with base raised to power lower than original
     */
     ...
     * check that the integer increases by 1...
     * ...while being added to integer before it
     */
    ...
    /**
     * checks whether or not first character of word matches 
     * the one at end of string
     */
